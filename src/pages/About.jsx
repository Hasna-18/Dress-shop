...
//             >
//               Mehar Nighty Center, Erattupetta Established in 2017, Mehar Nighty Center has become a trusted destination for quality ladies' wear in the heart of Erattupetta. We specialize in a diverse collection designed to blend comfort with contemporary style. Our extensive inventory includes premium nighty materials, elegant churidar pieces, and perfectly stitched ready-to-wear outfits. We are proud to offer both wholesale and retail options across our entire product range, making us the ideal choice for individual shoppers and business owners alike. At Mehar, we prioritize high-quality fabrics and affordable pricing. Whether you are looking for a single piece or bulk supplies, visit us to explore the perfect mix of tradition, trend, and value.            </motion.p>
//           </div>
//         </div>
//       </section>
...
import { motion } from "framer-motion";
import { Star, ShieldCheck, Heart, Leaf } from "lucide-react";
import ownerImg from "/assets/owner2.png"; // ✅ FIXED (no require)
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center">
            ...
            <div className="overflow-hidden mb-8">
              ...
              >
                About Our <br />
                <span className="italic font-light text-[#c4a77d]">
                  Shop
                </span>
              </motion.h1>
            </div>
            ...
            <motion.p
              ...
              className="mt-8 text-[#666] text-base md:text-lg max-w-2xl mx-auto font-light leading-relaxed px-4"
            >
              Mehar Nighty Center, Erattupetta, established in 2017, has become
              a trusted destination for quality ladies' wear in the heart of
              Erattupetta. We specialize in a diverse collection designed to
              blend comfort with contemporary style. Our extensive inventory
              includes premium nighty materials, elegant churidar pieces, and
              perfectly stitched ready-to-wear outfits. We proudly offer both
              wholesale and retail options, making us the ideal choice for
              individual customers and business owners. At Mehar, we prioritize
              high-quality fabrics and affordable pricing, ensuring the perfect
              mix of tradition, trend, and value.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto lg:grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-[40px] overflow-hidden shadow-2xl relative z-10">
              ...
              {/* OVERLAY */}
              <div className="absolute bottom-0 left-0 w-full bg-black/40 backdrop-blur-sm px-6 py-4">
                <p className="text-white text-lg md:text-xl font-semibold tracking-wide">
                  NOUFAL S MUTHUKATTIL
                </p>
              </div>
            </div>
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-serif font-semibold text-[#1a1a1a] mb-8 leading-tight">
              Designed with{" "}
              <span className="italic font-light">Purpose</span> & Detailed with
              Love
            </h2>
            ...
            <div className="space-y-6 text-[#555] font-light text-base md:text-lg leading-relaxed">
              ...
              <p>
                Mehar Nighty Center is owned by{" "}
                <strong>NOUFAL S MUTHUKATTIL</strong>, who has built a reputation
                for delivering quality ladies' wear with trust and consistency.
              </p>

              <p>
                We offer a wide range of products including nighties, churidars,
                parthas, gowns, and other ready-to-wear collections designed for
                comfort and style.
              </p>
              ...
              <div className="py-8 px-10 bg-[#faf8f5] rounded-3xl border border-gray-100 my-10 relative">
                <QuoteIcon className="absolute top-6 left-6 text-[#c4a77d]/20 w-12 h-12" />
                <p className="italic text-xl md:text-2xl text-[#1a1a1a] leading-tight font-serif">
                  "Our mission is to provide high-quality, comfortable, and
                  stylish ladies' wear at affordable prices for everyone."
                </p>
              </div>

              <p>
                <strong>Mission:</strong><br />
                To provide high-quality, comfortable, and stylish ladies' wear
                at affordable prices, catering to both individual customers and
                bulk buyers. We are committed to offering a diverse range of
                premium fabrics and ready-to-wear garments while ensuring
                excellent customer service and value for every purchase.
              </p>

              <p>
                <strong>Vision:</strong><br />
                To become a leading and trusted name in ladies' wear across the
                region, recognized for our quality, affordability, and
                trend-forward collections, while expanding our reach to serve a
                wider community of customers and business partners.
              </p>

              <p>
                <strong>Contact:</strong><br />
                Phone: 9544713654<br />
                Email: meharnighties@gmail.com
              </p>
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 bg-[#faf8f5]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-20">
            ...
            <h2 className="text-3xl md:text-5xl font-serif font-semibold text-[#1a1a1a]">
              Our Core Beliefs
            </h2>
          </div>
            ...
            {[
              {
                ...
                title: "Good Quality",
                desc: "We select the best materials available for our customers.",
              },
              {
                icon: <Leaf size={32} />,
                title: "Best Selection",
                desc: "Many designs and varieties in Hijabs, Shawls and Gowns.",
              },
              {
                icon: <Star size={32} />,
                title: "Daily Arrivals",
                desc: "New stock arriving regularly.",
              },
              {
                icon: <Heart size={32} />,
                title: "Customer Care",
                desc: "We help you find the right fit.",
              },
            ].map((value, i) => (
              <motion.div
                key={value.title}
              ...
              >
                <div className="w-16 h-16 bg-[#faf8f5] rounded-2xl flex items-center justify-center text-[#c4a77d] mb-6 mx-auto">
                  {value.icon}
                </div>
                <h3 className="text-xl font-serif font-semibold text-[#1a1a1a] mb-3">
                  {value.title}
                </h3>
                <p className="text-[#888] text-sm">{value.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
...
function QuoteIcon(props) {
  return (
    <svg {...props} fill="currentColor" viewBox="0 0 24 24">
      <path d="M14.017 21L14.017 18C14.017 16.8954 14.9124 16 16.017 16H19.017C19.5693 16 20.017 15.5523 20.017 15V9C20.017 8.44772 19.5693 8 19.017 8H15.017C14.4647 8 14.017 8.44772 14.017 9V12C14.017 12.5523 13.5693 13 13.017 13H10.017V21H14.017ZM10.017 21V13H7.017C6.46472 13 6.017 12.5523 6.017 12V9C6.017 8.44772 6.46472 8 7.017 8H11.017C11.5693 8 12.017 8.44772 12.017 9V15C12.017 15.5523 11.5693 16 11.017 16H8.017C7.46472 16 7.017 16.8954 7.017 18V21H10.017Z" />
    </svg>
  );
}