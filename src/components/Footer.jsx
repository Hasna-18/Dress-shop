    ...
    <footer className="bg-[#1a1a1a] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-medium uppercase tracking-[0.15em] mb-6 text-white/80">Quick Links</h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/40 text-sm">Mehar Nighty Center, Nadackal P O, Erattupetta, Pin: 686121</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={16} className="text-[#f4a7bb] shrink-0" />
                <span className="text-white/40 text-sm">+91 9544713654</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={16} className="text-[#f4a7bb] shrink-0" />
                <span className="text-white/40 text-sm">meharnighties@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
